...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    title: "Newlines",
    category: "Formatters",
    description: "Turn escaped newline markers in collapsed strings into readable lines.",
    aliases: ["newline", "newlines", "line break", "escaped newline", "multi-line", "multiline"],
    route: "/newlines",
    icon: FileText,
    component: lazy(() => import("./newline/NewlineTool")),
  },
  {
    id: "timestamp",
    title: "Time",
